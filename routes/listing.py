...
def all_listings():
    ...
    return render_template('all_listings.html', listings=listings, selected_category=category or 'All', search=search or '', selected_sort=sort_by)
